          ...
          <div className="form-group">
            ...
            <div className="form-body">
              ...
              <div className="form-group row">
                <label for="firstname" className="label-title col-sm-2">
                  Name:
                </label>
                <input
                  type="text"
                  id="firstname"
                  className="form-input col-md-6"
              ...
              {/* row class */}
              <div className="form-group row">
                <label for="class" className="label-title col-sm-2">
                  Class:
                </label>
                <input
                  type="number"
                  ...
                  className="form-input col-md-6"
                  value={props.class}
                  onChange={(e) => props.setClass(e.target.value)}
                />
              </div>
              {/* row birthdate */}
              <div className="form-group row">
                <label for="birthdate" className="label-title col-sm-2">
                  Birthdate:
                </label>
                <input
                  type="date"
              ...
              {/* row address */}
              <div className="form-group row">
                <label for="inputAddress" className="label-title col-sm-2">
                  Address:
                </label>
                {/* <div className="row"> */}
                <input
                  type="text"
                  className="form-input col-md-2 mb-3"
                  id="inputStreet"
                  placeholder="street"
                  value={props.street}
                ...
                <input
                  ...
                  placeholder="PaidFee :"
                  value={props.paidFee}
                  onChange={(e) => props.setPaidFee(e.target.value)}
                />
                <input
                  type="text"
                  className="form-input col-md-2"
                  id="inputAddress"
                  placeholder="RemainingFee :"
                  value={props.paidFee}
                  onChange={(e) => props.setPaidFee(e.target.value)}
                />
